export const EditIcon = (props: {onClick?: any}) => {
  return <svg onClick={props?.onClick} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
export const DeleteIcon = (props: {onClick?: any}) => {
  return <svg onClick={props?.onClick} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
